    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=.\\NHBAO;Initial Catalog=northwind;Persist Security Info=True;User ID=sa;Password=nguyenhabao;Pooling=False;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=True;");
            }
        }
